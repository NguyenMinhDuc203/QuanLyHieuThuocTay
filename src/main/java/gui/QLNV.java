...
public class QLNV extends JFrame implements MouseListener,ActionListener{
	...
	public QLNV() {
		...
		//Menu
				...
				ImageIcon poster = new ImageIcon(QLNV.class.getResource("/gui/poster.png"));
				...
				ImageIcon iconXoa = new ImageIcon(QLNV.class.getResource("/gui/320632131667326703-128.png"));
				...
				ImageIcon iconSua = new ImageIcon(QLNV.class.getResource("/gui/setting-icon.png"));
				...
				ImageIcon iconXT = new ImageIcon(QLNV.class.getResource("/gui/calendar-remove-icon.png"));
				...
				ImageIcon iconLuu = new ImageIcon(QLNV.class.getResource("/GUI/save-icon.png"));
				...
				table.getColumnModel().getColumn(10).setPreferredWidth(77);
				table.getColumnModel().getColumn(12).setPreferredWidth(46);
				table.getColumnModel().getColumn(13).setPreferredWidth(74);
				...
				ImageIcon iconThoat = new ImageIcon(QLNV.class.getResource("/gui/exit-icon.png"));
	...
	public JMenuBar createMenuBar() {
	 ...
	 // Menu Trang Chủ
	    ...
	    manageMenuItem1.addActionListener(createMenuActionListener(this, QLNV.class));
	    manageMenuItem2.addActionListener(createMenuActionListener(this, QLNV.class));
	    manageMenuItem3.addActionListener(createMenuActionListener(this, QLNV.class));
