...
public class Thu extends JFrame implements MouseListener,ActionListener{
	...
	public Thu() {
		...
		//Menu
				...
				ImageIcon poster = new ImageIcon(Thu.class.getResource("/gui/poster.png"));
				...
				ImageIcon iconThem = new ImageIcon(Thu.class.getResource("/gui/4993253681582956831-128.png"));
				...
				ImageIcon iconXoa = new ImageIcon(Thu.class.getResource("/gui/320632131667326703-128.png"));
				...
				ImageIcon iconSua = new ImageIcon(Thu.class.getResource("/gui/setting-icon.png"));
				...
				ImageIcon iconXT = new ImageIcon(Thu.class.getResource("/gui/calendar-remove-icon.png"));
				...
				ImageIcon iconLuu = new ImageIcon(Thu.class.getResource("/GUI/save-icon.png"));
				...
				ImageIcon iconThoat = new ImageIcon(Thu.class.getResource("/gui/exit-icon.png"));
	...
	public JMenuBar createMenuBar() {
	 ...
	 // Menu Trang Chủ
	   ...
	   // salesMenu.addMouseListener(createMenuMouseAdapter(this, BanHang_GUI.class));
	    ...
	    manageMenuItem1.addActionListener(createMenuActionListener(this, Thu.class));
	    manageMenuItem2.addActionListener(createMenuActionListener(this, Thu.class));
	    manageMenuItem3.addActionListener(createMenuActionListener(this, Thu.class));
